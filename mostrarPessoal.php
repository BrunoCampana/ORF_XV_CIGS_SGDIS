                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <center>Ficha de Pessoal</center>
                        </h1>
                    </div>
                </div><br>
                <!-- /.row -->
                ...
                <legend>Dados Situacionais</legend>
                  <div class="row">
                      <div class="form-group">
                          ...
                          <div class="col-lg-4">
                              ...
                              <input class="form-control" type="text" name="ng" readonly>
                          </div>
                          <div class="col-lg-2">
                  ...
                  <div class="row">
                      <div class="form-group">
                          <div class="col-lg-2">
                              <label>A / Q / S</label>
                              <input class="form-control" type="text" name="aqs" readonly>
                          </div>
                          <div class="col-lg-2">
                              <label>P / G</label>
                              <input class="form-control" type="text" name="pg" readonly>
                          </div>
                          <div class="col-lg-2">
                              <label>Força</label>
                              <input class="form-control" type="text" name="forca" readonly>
                          </div>
                          <div class="form-group col-sm-4">
                             <label>País de Origem</label>
                             <select class="form-control" name="po" readonly>
                               <option value=""></option>
                  ...
                  <div class="row">
                      <div class="form-group">
                          <div class="form-group col-sm-2 format">
                             ...
                             <select class="form-control" name="cf" readonly>
                               <option value=""></option>
                          ...
                          <div class="col-lg-2 format">
                              ...
                              <input class="form-control" type="text" name="omo" readonly>
                          </div>
                      	<div class="form-group col-sm-3 format">
                             <label>RM</label>
                             <select class="form-control" name="rm" readonly>
                               <option value=""></option>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-lg-2">
                              ...
                              <label class="radio-inline">
                                  <input type="radio" value="M" <?php if (isset($tipo) && $tipo == "M") echo "checked";?> name="tipo">M                                </label>
                              <label class="radio-inline">
                                  <input type="radio" value="F" <?php if (isset($tipo) && $tipo == "F") echo "checked";?> name="tipo">F                                </label>
                          </div>
                      </div>
                  </div><br>
                  <div class="row">
                      <div class="form-group">
                          ...
                          <div class="col-lg-4">
                              ...
                              <input class="form-control" type="date" name="dn" readonly>
                          </div>
                      </div>
                      </div><br/>
                  <div class="row">
                      <div class="form-group">
                          <div class="col-lg-2">
                              ...
                              <input class="form-control" type="text" name="ec" readonly>
                          </div>
                          <div class="col-lg-2">
                              <label>Naturalidade</label>
                              <input class="form-control" type="text" name="naturalidade" readonly>
                          </div>
                          <div class="col-lg-2">
                              <label>Nacionalidade</label>
                              <input class="form-control" type="text" name="nacionalidade" readonly>
                          </div>
                          <div class="col-lg-2">
                              <label>CPF</label>
                              <input class="form-control" type="text" name="cpf" size="11" maxlength="11" placeholder="só dígitos" readonly>
                          </div>
                      </div>
                  </div><br>
                  <div class="row">
                      <div class="form-group">
                          <div class="col-lg-2">
                              <label>RG</label>
                              <input class="form-control" type="number" min="0" step="1" name="rg" size="16" maxlength="16" placeholder="só dígitos" readonly>
                          </div>
                          <div class="col-lg-4">
                              <label>Órgão Expeditor</label>
                              <input class="form-control" type="text" name="oe" readonly>
                          </div>
                          <div class="col-lg-4">
                              <label>Data de Expedição</label>
                              <input class="form-control" type="date" name="de" readonly>
                          </div>
                      </div>
                  </div><br>
                  <div class="row">
                      <div class="form-group">
                          <div class="col-lg-2">
                              <label>Id Mil</label>
                              <input class="form-control" type="number" min="0" step="1" name="im" size="16" maxlength="16" placeholder="só dígitos" readonly>
                          </div>
                          <div class="col-lg-2">
                              <label>PREC / CP</label>
                              <input class="form-control" type="number" min="0" step="1" name="preccp" size="9" maxlength="9" placeholder="só dígitos" readonly>
                          </div>
                      </div>
                  </div><br>
                  <div class="row">
                      <div class="form-group">
                          <div class="col-lg-4">
                              ...
                              <input class="form-control" type="number" min="0" step="1" name="te" size="12" maxlength="12" placeholder="só dígitos" readonly>
                          </div>
                          <div class="col-lg-2">
                              <label>Zona</label>
                              <input class="form-control" type="number" min="0" step="1" name="zona" readonly>
                          </div>
                          <div class="col-lg-2">
                              <label>Seção</label>
                              <input class="form-control" type="number" min="0" step="1" name="secao" readonly>
                          </div>
                      </div>
                  </div><br>
                  <div class="row">
                      <div class="form-group">
                          <div class="col-lg-4">
                              ...
                              <input class="form-control" type="text" name="pai" readonly>
                          </div>
                          <div class="col-lg-4">
                              <label>Filiação Materna</label>
                              <input class="form-control" type="text" name="mae" readonly>
                          </div>
                      </div>
                  </div><br>
            </fieldset>
                ...
                <legend>Dados de Endereço</legend>
                   <div class="form-group">
                      <div class="row">
                          <div class="col-lg-4">
                              <label>Rua</label>
                              <input class="form-control" type="text" name="rua" readonly>
                          </div>
                          <div class="col-lg-1">
                              <label>Numero</label>
                              <input class="form-control" type="number" min="0" step="1" name="numero" readonly>
                          </div>
                          <div class="col-lg-2">
                              <label>Complemento</label>
                              <input class="form-control" type="text" name="complemento" readonly>
                          </div>
                          <div class="col-lg-3">
                              <label>Bairro</label>
                      ...
                      <div class="row">
                          <div class="col-lg-2">
                              <label>Cidade</label>
                              <input class="form-control" type="text" name="cidade" readonly>
                          </div>
                          <div class="col-lg-2">
                             <label>UF</label>
                             <select class="form-control" name="uf" readonly>
                               <option value=""></option>
			...
			<fieldset>
			  ...
			  <div class="row"> 
			    <div class="col-lg-8 col-lg-offset-3">
			        ...
			        <a href="dadoMedico.php" class="btn btn-primary" role="button">FMDs</a>
